...
typedef struct sfs_file_entry
{
	 ...
	 */
	char name[SIMULA_FS_FILENAME_LEN+1]; /* File "name" of size SIMULA_FS_FILENAME_LEN + 1 */
	...
	byte4_t blocks[SIMULA_FS_DATA_BLOCK_CNT]; /* Array of 4-byte indices of file's data "blocks" */
} sfs_file_entry_t;
